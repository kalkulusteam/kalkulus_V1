...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // Kalkulus: 128 bytes + little extra

static const int64 MIN_TX_FEE = 100000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 20000000 * COIN; // Kalkulus money supply: maximum of 20M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; //720 blocks found X day
    }
