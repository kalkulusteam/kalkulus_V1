...
static const CKalkulusAddress addr1 ("LWaFezDtucfCA4xcVEfs3R3xfgGWjSwcZr");
static const CKalkulusAddress addr2 ("LXwHM6mRd432EzLJYwuKQMPhTzrgr7ur9K");
static const CKalkulusAddress addr1C("LZWK8h7C166niP6GmpUmiGrvn4oxPqQgFV");
static const CKalkulusAddress addr2C("Lgb6tdqmdW3n5E12johSuEAqRMt4kAr7yu");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CKalkulusAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CKalkulusSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
